...
I chose the AnimeTracker component because it’s both realistic to build and something I’m actually interested in. It involves organizing data and calculating things like average ratings and total episodes watched, which feels very doable within a semester. Compared to something like the PasswordVault, it doesn’t require dealing with complicated security concerns, so it’s more manageable for my current skill level. It also has enough different behaviors to make it a strong candidate for adapting into the OSU layered discipline later. Plus, since I enjoy anime, I’ll probably stay more motivated while working on it.
